...
import TileEditor2 from "./ui/tileEditor2.js";
...
/** @type {TileEditor2} */ let tileEditor;
...
async function initialiseComponents() {
    ...
    tileEditor = await TileEditor2.loadIntoAsync(document.querySelector('[data-smsgfx-component-id=tile-editor]'));
