...
export default class Palette {
    ...
    loadMasterSystemPalette(array) {
        this.#colours = Palette.#loadMasterSystemPalette(array);
    }
    ...
    loadGameGearPalette(array) {
        this.#colours = Palette.#loadGameGearPalette(array);
    }
     ...
     */
    static #loadMasterSystemPalette(array) {
        /** @type {PaletteColour[]} */
        const result = [];
     ...
     * @returns {PaletteColour[]}
     */
    static #loadGameGearPalette(array) {
        /** @type {PaletteColour[]} */
        const result = [];
