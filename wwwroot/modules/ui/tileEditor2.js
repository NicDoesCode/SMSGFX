...
export default class TileEditor2 {
    ...
    constructor(element) {
        ...
        this.#tbCanvas = this.#element.querySelector('[data-sms-id=tile-editor2-canvas]');
        ...
        TileEditorContextMenu.loadIntoAsync(this.#element.querySelector('[data-smsgfx-component-id=tile-editor2-context-menu]'))
            .then((obj) => {
     ...
     * @returns {Promise<TileEditor2>}
     */
    static async loadIntoAsync(element) {
        const componentElement = await TemplateUtil.replaceElementWithComponentAsync('tileEditor2', element);
        return new TileEditor2(componentElement);
    }
